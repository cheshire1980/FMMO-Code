...
public class QuestLogUI : MonoBehaviour {
	...
	public class QuestButtonVars
	{
		...
		[HideInInspector]
		public QuestC ChildQuest;
	}
	public QuestButtonVars[] QuestButtons;
	[HideInInspector]
	...
	void  SetQuestLogPosition (){
		...
		OffsetY = UICanvas.rect.height/2-Panel.GetComponent<RectTransform>().rect.height;
		OffsetX = UICanvas.rect.width/2-Panel.GetComponent<RectTransform>().rect.width;
	...
	public void  LoadActiveQuests (){
		...
		foreach(QuestC TempQuest in Quests) 
		{
